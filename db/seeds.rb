...
team_member1 = TeamMember.create(fname: "Kyle", lname: "Steinmann", title: "Developer", img_url: "https://fastly.picsum.photos/id/10/2500/1667.jpg?hmac=J04WWC_ebchx3WwzbM-Z4_KC_LeLBWr5LZMaAkWkF68", team_id:5)
team_member2 = TeamMember.create(fname: "Heath", lname: "Falkenrath", title: "Developer", img_url: "https://fastly.picsum.photos/id/10/2500/1667.jpg?hmac=J04WWC_ebchx3WwzbM-Z4_KC_LeLBWr5LZMaAkWkF68", team_id:5)
team_member3 = TeamMember.create(fname: "Chris", lname: "Hembree", title: "Developer", img_url: "https://fastly.picsum.photos/id/505/200/200.jpg?hmac=c295sjTIAZ_9Gj-PENrzAbATNIiWPL1dmhIhWndYnyo", team_id:5)
team_member4 = TeamMember.create(fname: "Joe", lname: "Letner", title: "Developer", img_url: "https://fastly.picsum.photos/id/18/2500/1667.jpg?hmac=JR0Z_jRs9rssQHZJ4b7xKF82kOj8-4Ackq75D_9Wmz8", team_id:2)
team_member5 = TeamMember.create(fname: "Trevor", lname: "Biri", title: "Developer", img_url: "https://fastly.picsum.photos/id/15/2500/1667.jpg?hmac=Lv03D1Y3AsZ9L2tMMC1KQZekBVaQSDc1waqJ54IHvo4", team_id:2)
team_member6 = TeamMember.create(fname: "Sara", lname: "Hampson", title: "Developer", img_url: "https://fastly.picsum.photos/id/13/2500/1667.jpg?hmac=SoX9UoHhN8HyklRA4A3vcCWJMVtiBXUg0W4ljWTor7s", team_id:2)
